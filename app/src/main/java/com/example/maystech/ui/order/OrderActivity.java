...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.getDelivery().observe(this, d ->
        {
            ...
            viewModel.postProductToDelivery(productOrdersList);
        ...
        viewModel.getMessage().observe(this, m ->
        {
            ...
            if (m.equals("Đặt hàng thành công"))
            {
                setResult(RESULT_OK);
                finish();
            }
    ...
    {
        binding.tvTotalPayment.setText(STATIC.formatPrice(delivery.getTotalPrice()));
    }
    ...
    ItemProductOrder convertProductInCartToOrder(ItemProductInCart itemProductInCart)
    {
        ...
        itemProductOrder.setProductName(itemProductInCart.getProductName());
        itemProductOrder.setProductImage(itemProductInCart.getProductImage());
