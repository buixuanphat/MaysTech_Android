package com.example.maystech.ui.profile.shipping;
...
public class ShippingFragment extends Fragment {
    ...
    public void onResume() {
        ...
        fetchDeliveryOfUser(u.getId(), STATIC.SHIPPING);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.rvShippingProduct.setLayoutManager(new LinearLayoutManager(requireContext()));
        binding.rvShippingProduct.setAdapter(productOrderAdapter);
